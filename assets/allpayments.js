...
$(document).ready(function() {
  // LOAD COUNTY SHAPE
  var counties = $.ajax({
    url:"/assets/1831CountiesPlusCitiesWGS84.simple.geo.geojson",
    dataType: "json",
      ...
      var mycounties = L.geoJSON(counties.responseJSON,
         {
           ...
           onEachFeature: function (feature, layer) {
               layer.bindTooltip(feature.properties.A_CTY31, {className: 'parishtooltip'});
  ...
  $.ajax({
    ...
    success: function(csvdata) {
      ...
      data.data.forEach(function(place) {
        //console.log(place);
        if (place.latlng != "0,0" && place.latlng != ",")
        {
